      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-[var(--gradient-brand)] relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold tracking-tight">AVISYS</span>
          </div>
        </div>
        <div className="relative space-y-6 max-w-md">
          ...
          <p className="text-muted-foreground text-lg">
            Upload incident reports, telemetry transcripts, or sensor logs. AVISYS extracts events, identifies root causes, flags compliance risks, and drafts coaching plans — in seconds.
          </p>
