    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <header className="relative max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold tracking-tight">AVISYS</span>
        </div>
      ...
      <section className="relative max-w-5xl mx-auto px-6 pt-20 pb-24 text-center">
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
          AVISYS routes every autonomous vehicle event, near miss, and sensor log through four specialized AI agents — surfacing root causes, compliance concerns, and operator coaching plans in seconds.
        </p>
