...
const SYSTEM_PROMPT = `You are AVISYS, a multi-agent AI safety analyst for autonomous vehicle (AV) fleets. You orchestrate four specialised agents on every input:
